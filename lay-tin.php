...
Description: Plugin lấy tin từ vnExpress, <a href="http://webbinhdan.com/2016/08/04/huong-dan-lay-tin-tu-vnexpress-bang-plugin-lay-tin-vnexpress-cho-wordpress/" target="_blank">Hướng dẫn chi tiết cài đặt</a>. Nếu bạn muốn lấy tin từ trang khác hoặc thêm tính năng đặc biệt xin liên hệ với <a href="http://webbinhdan.com" target="_blank">WebBinhDan.com</a>
Version: 1.0.8
                    ...
                    <tbody>                     	
                        ...
                        <tr>
                            ...
                            <td>
                            	...
                            	<textarea placeholder="http://vnexpress.net/tin-tuc/the-gioi/ 3 1 1 0 1 1,2 5
http://kinhdoanh.vnexpress.net/ 5 2 1 0 1 1,2 7" onmouseover="textAreaAdjust(this)"  onmouseleave="textAreaAdunjust(this)" class="large-text code" rows="5" name="get_news_link" ><?php echo get_option('get_news_link'); ?></textarea>
